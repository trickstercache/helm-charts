...
If you would like to contribute to this project you can do so through GitHub by forking the repository and sending a pull request.
...
* Branch from the `master` and, if needed, rebase to the current master branch before submitting your pull request. If it doesn't merge cleanly with master you may be asked to rebase your changes. If you are working on a feature release, you may be asked to use a different branch as your base.
